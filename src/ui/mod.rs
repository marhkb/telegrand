...
pub(crate) use self::session::SidebarChatFolderBar;
pub(crate) use self::session::SidebarChatFolderIcon;
pub(crate) use self::session::SidebarChatFolderRow;
pub(crate) use self::session::SidebarChatFolderSelection;
...
pub(crate) fn init() {
    ...
    SidebarChatFolderBar::static_type();
    SidebarChatFolderIcon::static_type();
    SidebarChatFolderRow::static_type();
    SidebarChatFolderSelection::static_type();
